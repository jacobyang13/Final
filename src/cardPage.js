        ...
        {Object.keys(this.state.heroCards).map((key, id) => (
          ...
          <div key={id}>
            <div id={this.state.heroCards[key].id} className="result" >
              ...
              <div><iframe width="600" height="450" frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?q=hibachi%20and%20company&key=AIzaSyBD2pY0bUHkG05T6jCfQCa04QGomHQmtpk" allowfullscreen></iframe></div>
              <form>
